          ...
          <div className="flex flex-col lg:flex-row lg:items-start lg:justify-between gap-8 mb-16">
            ...
            >
              <p className="text-zinc-400 leading-relaxed">
                Платформа создана для тех, кто хочет заниматься фитнесом без лишних сложностей:
                удобное бронирование, профессиональные тренеры и гибкое расписание.{" "}
                <a href="#" className="text-white inline-flex items-center gap-1 hover:underline">
                  Подробнее о платформе <ChevronRight className="w-4 h-4" />
                </a>
              </p>
            </motion.div>
          </div>
